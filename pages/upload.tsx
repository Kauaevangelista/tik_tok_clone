    ...
    <div className='flex w-full h-full absolute left-0 top-[60px] lg:top-[70px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
      <div className=' bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-center items-center p-14 pt-6'>
        <div>
                    ...
                    <div className='flex flex-col items-center justify-center h-full'>
                      <div className='flex flex-col justify-center items-center'>
                        ...
                        <p className='text-xl font-semibold'>
                          Selecione video para upload
                        </p>
                      </div>

                      <p className='text-gray-400 text-center mt-10 text-sm leading-10'>
                        MP4 or WebM or ogg <br />
                        Resolução 720x1280 ou maior <br />
                        Até 10 minutos <br />
                        Menor que 2 GB
                      </p>
                      <p className='bg-[#F51997] text-center mt-8 rounded text-white text-md font-medium p-2 w-52 outline-none duration-500 hover:bg-[#b60d6c]'>
                        Selecione o video
                      </p>
                    </div>
                    <input
          ...
          {wrongFileType && (
            <p className='text-center text-xl text-red-400 font-semibold mt-4 mb-5 w-[260px]'>
              Por favor selecione um arquivo de video (mp4, webm ou ogg)
            </p>
          )}
        </div>
        <div className='flex flex-col gap-3 pb-10'>
          ...
          <div className='flex gap-6 mt-10'>
            ...
            <button
              ...
              onClick={handlePost}
              type='button'
              className='bg-[#F51997] text-white text-md font-medium p-2 rounded w-28 lg:w-44 outline-none duration-500 hover:bg-[#b60d6c]'
            >
